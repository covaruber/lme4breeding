---
title: "Extracting the parameters and predictions from lme4breeding models"
...
Alternatively, you can extract the posterior conditional variance matrix and extract the standard error from coefficients taking the square root from the diagonal elements of the matrix.
